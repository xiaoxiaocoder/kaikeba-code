...
const tokenCache = require("../utils/token");
...
router.get('/getFollowerInfo', async ctx => {    
  const url = `https://api.weixin.qq.com/cgi-bin/user/info?access_token=${tokenCache.access_token}&openid=${ctx.query.openid}&lang=zh_CN`    
  const res = await axios.get(url)    
  console.log('getFollowers', res.data)    
  ctx.body = res.data
})
